gsap.registerPlugin(ScrollTrigger);
    const lenis = new Lenis({
        duration: 0.5, // Reduced duration for smoother scrolling
        easing: (t) => Math.min(1, 1.001 - Math.pow(2, -10 * t)),
        direction: 'vertical',
        gestureDirection: 'vertical',
        smooth: true,
        mouseMultiplier: 0.6, // Reduced mouse multiplier
        smoothTouch: false,
        touchMultiplier: 1.2, // Reduced touch multiplier
        infinite: false,
    });
...
// Optimize performance by limiting scroll updates
